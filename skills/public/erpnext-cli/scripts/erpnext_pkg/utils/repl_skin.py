...
class ReplSkin:
    ...
    def __init__(self, software: str, version: str = "1.0.0",
        ...
        # cli_anything/<software>/skills/_SKILL.md for installed harnesses.
        # The leading underscore hides the packaged copy from recursive
        # SKILL.md scans performed by agent harnesses (e.g. DeerFlow) that
        # would otherwise index this pip-install descriptor as a duplicate
        # skill when the bundle is extracted into their skills tree.
        if skill_path is None:
            package_skill = Path(__file__).resolve().parent.parent / "skills" / "_SKILL.md"
            repo_skill = None
